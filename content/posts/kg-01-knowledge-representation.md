...
这条线也是整个语义网技术栈命运的预告：描述逻辑被选作语义网的逻辑基础，而它天生带着表达能力的上限。
...
回头看这几层的关系，其实是一套分工：RDF 负责让数据进得来，RDFS 给词汇一点结构，OWL 负责严格的那部分语义。没有哪一层打算把所有事都做完。

## 八、这一路到底在权衡什么

把这条线拉通，只有一个变量在反复被调：**表达的野心和推理的代价。**
